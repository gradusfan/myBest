...
{
    [Serializable]
    public class DistanceAngleLineLineTool : ImageTool
    {
        [NonSerialized]
        HTuple hv_rowA1;
        [NonSerialized]
        ...
        public override void dispresult()
        {
            try
            {
                ...
                {
                    HOperatorSet.SetColor(WindowControl.HalconWindow, "green");
                    HOperatorSet_Ex.disp_angle((HObject)ho_Image[ImageName], hv_rowA1, hv_colA1, hv_rowA2, hv_colA2, hv_rowB1, hv_colB1, hv_rowB2, hv_colB2, out hv_Row, out hv_Col, WindowControl.HalconWindow);
                    HOperatorSet_Ex.disp_message(WindowControl.HalconWindow, "两线夹角:" + hv_angle.TupleString("0.03f"), "image", hv_Row + 30, hv_Col, "white", "forest green");
                ...
                else
                {
                    ...
                    disp_angle((HObject)ho_Image[ImageName], hv_rowA1, hv_colA1, hv_rowA2, hv_colA2, hv_rowB1, hv_colB1, hv_rowB2, hv_colB2,out hv_Row,out hv_Col, WindowControl.HalconWindow);
                    HOperatorSet_Ex.disp_message(WindowControl.HalconWindow, "两线夹角:" + hv_angle.TupleString("0.03f"), "image", hv_Row + 30, hv_Col, "white", "red");
                }
                HSystem.SetSystem("flush_graphic", "false");
            }
        ...
        public void SelectPointLine(string line1, string line2)
        {
            ...
            HOperatorSet.AngleLl(hv_rowA1, hv_colA1, hv_rowA2, hv_colA2, hv_rowB1, hv_colB1, hv_rowB2, hv_colB2, out hv_phi);
